...
func TestReElection(t *testing.T) {
	...
	DPrintf("Test 0 started.")
	leader1 := cfg.checkOneLeader()
	DPrintf("Test 0 passed.")

	// if the leader disconnects, a new one should be elected.
	DPrintf("Test 1 started. #%d disconnected.", leader1)
	...
	DPrintf("Test 2 started. #%d reconnected.", leader1)
	cfg.connect(leader1)
	...
	// be elected.
	DPrintf("Test 3 started. #%d and #%d disconnected.", leader2, (leader2+1)%servers)
	...
	DPrintf("Test 4 started. #%d reconnected.", (leader2+1)%servers)
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()
	DPrintf("Test 4 passed.")

	// re-join of last node shouldn't prevent leader from existing.
	DPrintf("Test 5 started. #%d reconnected.", leader2)
	cfg.connect(leader2)
	cfg.checkOneLeader()
	DPrintf("Test 5 passed.")
